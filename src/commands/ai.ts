  ...
  return {
    ...
    runtime_config: request.runtime_config
        ? {
          ...
          width_node_id: request.runtime_config.widthNodeId,
          height_node_id: request.runtime_config.heightNodeId,
          seed_node_id: request.runtime_config.seedNodeId,
          steps_node_id: request.runtime_config.stepsNodeId,
          cfg_node_id: request.runtime_config.cfgNodeId,
          denoise_node_id: request.runtime_config.denoiseNodeId,
        }
      : undefined,
  };
}
