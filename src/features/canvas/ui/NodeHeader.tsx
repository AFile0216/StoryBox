...
export const NODE_HEADER_TONE_CLASS = 'text-[rgba(var(--text-rgb),0.72)]';
    ...
    if (isEditingTitle) {
      return (
        <input
          ...
          className={joinClasses(
            'nodrag nowheel h-6 min-w-[70px] w-full max-w-full rounded border border-[var(--ui-border-soft)] bg-[var(--ui-overlay-panel)] px-2 text-[13px] font-normal text-text-dark outline-none focus:border-accent/70',
            titleClassName
          )}
        />
      );
